...
const CategorySection = ({ category, details }) => (
  <div className="mb-6">
    <h4 className="text-3xl sm:text-4xl md:text-5xl font-bold text-blue-700 dark:text-blue-300 mb-2">
      🔹 {category}
    </h4>
...
const Array = () => {
  ...
  return (
    <div className="w-full px-4 sm:px-6 md:px-8 max-w-7xl mx-auto py-10">
