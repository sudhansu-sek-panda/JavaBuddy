...
const Roadmap = () => {
  ...
  return (
    <div className="min-h-screen pt-28  bg-gradient-to-br from-black via-[#0f0f3f] to-black text-white p-6">
          ...
          {roadmapData.map((section, index) => (
            ...
            >
              <div className="absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 top-0">
                <div
                  className={`w-14 h-14 flex items-center justify-center rounded-full shadow-xl border-4 border-white bg-gradient-to-br ${section.color}`}
                >
